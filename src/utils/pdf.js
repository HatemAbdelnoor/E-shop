...
function generateHeader(doc) {
    doc
        .image(path.join(__dirname, './images/318335136_3516215858636420_3404208237080697462_n.jpg'), 50, 45, { width: 50 })
        .fillColor("#09c")
        .fontSize(20)
        .text("Hatem-Abdelnoor.", 110, 57)
        .fontSize(10)
...
function generateCustomerInformation(doc, invoice) {
    ...
    doc
        ...
        .text(formatDate(invoice.createAt), 150, customerInformationTop + 15)
